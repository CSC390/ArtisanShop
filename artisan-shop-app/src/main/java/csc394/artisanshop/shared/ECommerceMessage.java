package csc394.artisanshop.shared;
...
public interface ECommerceMessage {
    ...
    String LOGIN_BODY = String.valueOf(new Date().toString()
            + " If you are not logged in on this date, we recommend that you change your password.");
